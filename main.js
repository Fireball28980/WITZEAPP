...
import { saveJoke, getSavedJokes, removeJoke } from "./stroing"; // Korrektur: "./storing"
...
const saveJokesListEl = document.querySelector(".saved-jokes__list");
...
async function loadNewJoke() {
  ...
  currentJoke = joke;
  currentJokeEl.textContent = joke; // Verwenden von textContent für Sicherheit
}
...
window.removeSavedJoke = removeSavedJoke; // Sicherstellen, dass die Funktion global verfügbar ist
...
function renderSavedJokes() {
  ...
  saveJokesListEl.innerHTML = html;
}
